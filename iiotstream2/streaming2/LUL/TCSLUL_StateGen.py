...
raw_lul=pd.read_csv('LUL_IMU4.csv', usecols=['time', 'ax', 'az'])
...
board=scipy.signal.find_peaks(test_lul.rlg_acc, height=(height_thresh), distance=timethresh*sampling_rate, width=1)
...
# # sns.distplot(LUL_events.working_time)
# # plt.title('UnLoader UnLoading Times Histogram')
