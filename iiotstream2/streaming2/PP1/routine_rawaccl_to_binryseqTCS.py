...
def rawaccl_to_binryseq(inp_vibr_df,downsample_rate,use_filt_accl_flag,use_quant_sig_flag,HYS_LOW_THRESH,HYS_HIGH_THRESH):
    ...
    + 1.50 * ((acc_sig >= 1.50) & (acc_sig < 1.55)) \
    + 1.55 * ((acc_sig >= 1.55) & (acc_sig < 1.60)) \
    + 1.60 * ((acc_sig >= 1.60) & (acc_sig < 1.65)) \
    + 1.65 * ((acc_sig >= 1.65) & (acc_sig < 1.70)) \
    + 1.70 * ((acc_sig >= 1.70) & (acc_sig < 1.75)) \
    + 1.75 * ((acc_sig >= 1.75) & (acc_sig < 1.80)) \
    + 1.80 * ((acc_sig >= 1.80) & (acc_sig < 1.85)) \
    + 1.85 * ((acc_sig >= 1.85) & (acc_sig < 1.90)) \
    + 1.90 * ((acc_sig >= 1.90) & (acc_sig < 1.95)) \
    + 1.95 * ((acc_sig >= 1.95) & (acc_sig < 2.00)) \
    + 2.00 * (acc_sig >= 2.00)\
    ;
    ...
    h1_df,h1_mode = gen_histogram(filt_sig_df.quant_sig,0,0.05)
