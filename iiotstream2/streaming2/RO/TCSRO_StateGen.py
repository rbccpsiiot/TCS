...
rf_raw=pd.read_csv('RO_EM6.csv', usecols =['time', 'c1', 'c2', 'c3'])
...
rf_raw['state'][rf_raw['rolling_sum_std']<=1]=0
rf_raw['state'][rf_raw['rolling_sum_std']>= 400]=2
rf_raw['state'][(rf_raw['rolling_sum_std']>10) & (rf_raw['rolling_sum_std']<60)]=1
